    ...
    async def analyze(self, extracted_text: str) -> CampaignKnowledge:
        ...
        payload = {
                    ...
                    "parts": [
                        {
                            "text": (
                                SYSTEM_PROMPT
                                + "\n\nAnalyze the following campaign PDF text:\n\n"
                                + extracted_text
                            )
                        }
                    ],
            ...
            "generationConfig": {
                ...
                "responseJsonSchema": CampaignKnowledge.model_json_schema(),
                "temperature": 0.1,
            },
        }
        ...
        try:
            ...
            return CampaignKnowledge.model_validate(json.loads(output_text))
